...
@_Const_String_.3 = private constant [9 x i8] c"success\0A\00"
...
loop:                                             ; preds = %cond
  ...
  %printf2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @_Const_String_.2, i32 0, i32 0), i8 %tmpvar)
  %tmparray3 = getelementptr inbounds [10 x i8], [10 x i8]* %b, i32 0, i32 0
  %tmpvar4 = load i8, i8* %tmparray3
  %icmptmp = icmp eq i8 %tmpvar4, 101
  %ifCond = icmp ne i1 %icmptmp, false
  br i1 %ifCond, label %if, label %afterifonly

afterLoop:                                        ; preds = %if, %cond
  %printf5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @_Const_String_.3, i32 0, i32 0))
  store i32 0, i32* %0
  br label %return
